...
/// Defines the layout and behavior of a [BottomNavigationBarr].
///
/// For a sample on how to use these, please see [BottomNavigationBarr].
/// See also:
///
///  * [BottomNavigationBarr]
///  * [BottomNavigationBarrItem]
///  * <https://material.io/design/components/bottom-navigation.html#specs>
enum BottomNavigationBarrType {
  /// The [BottomNavigationBarr]'s [BottomNavigationBarrItem]s have fixed width.
  fixed,

  /// The location and size of the [BottomNavigationBarr] [BottomNavigationBarrItem]s
  /// animate and labels fade in when they are tapped.
  shifting,
}

/// Refines the layout of a [BottomNavigationBarr] when the enclosing
/// [MediaQueryData.orientation] is [Orientation.landscape].
enum BottomNavigationBarrLandscapeLayout {
...
/// where it is provided as the [Scaffold.BottomNavigationBarr] argument.
///
/// The bottom navigation bar's [type] changes how its [items] are displayed.
/// If not specified, then it's automatically set to
/// [BottomNavigationBarrType.fixed] when there are less than four items, and
/// [BottomNavigationBarrType.shifting] otherwise.
///
/// The length of [items] must be at least two and each item's icon and
/// label must not be null.
///
///  * [BottomNavigationBarrType.fixed], the default when there are less than
...
///  * [BottomNavigationBarrType.shifting], the default when there are four
...
///    [BottomNavigationBarrItem.backgroundColor] of the selected item. In this
...
/// To update from [BottomNavigationBarr] to [NavigationBar], you will
/// need to make the following changes.
///
/// 1. Instead of using [BottomNavigationBarr.items], which
/// takes a list of [BottomNavigationBarrItem]s, use
/// [NavigationBar.destinations], which takes a list of widgets.
/// Usually, you use a list of [NavigationDestination] widgets.
/// Just like [BottomNavigationBarrItem]s, [NavigationDestination]s
/// have a label and icon field.
///
/// 2. Instead of using [BottomNavigationBarr.onTap],
/// use [NavigationBar.onDestinationSelected], which is also
/// a callback that is called when the user taps on a
/// navigation bar item.
///
/// 3. Instead of using [BottomNavigationBarr.currentIndex],
...
///
/// ## Using [BottomNavigationBarr]
///
/// {@tool dartpad}
/// This example shows a [BottomNavigationBarr] as it is used within a [Scaffold]
/// widget. The [BottomNavigationBarr] has three [BottomNavigationBarrItem]
/// widgets, which means it defaults to [BottomNavigationBarrType.fixed], and
...
///
/// {@tool dartpad}
/// This example shows how you would migrate the above [BottomNavigationBarr]
...
/// {@tool dartpad}
/// This example shows a [BottomNavigationBarr] as it is used within a [Scaffold]
/// widget. The [BottomNavigationBarr] has four [BottomNavigationBarrItem]
/// widgets, which means it defaults to [BottomNavigationBarrType.shifting], and
/// the [currentIndex] is set to index 0. The selected item is amber in color.
/// With each [BottomNavigationBarrItem] widget, backgroundColor property is
/// also defined, which changes the background color of [BottomNavigationBarr],
...
///
/// {@tool dartpad}
/// This example shows [BottomNavigationBarr] used in a [Scaffold] Widget with
/// different interaction patterns. Tapping twice on the first [BottomNavigationBarrItem]
/// uses the [ScrollController] to animate the [ListView] to the top. The second
/// [BottomNavigationBarrItem] shows a Modal Dialog.
///
...
class BottomNavigationBarr extends StatefulWidget {
  ...
  /// [Scaffold]'s [Scaffold.BottomNavigationBarr] argument.
  ///
  /// The length of [items] must be at least two and each item's icon and label
  /// must not be null.
  ///
  /// If [type] is null then [BottomNavigationBarrType.fixed] is used when there
  /// are two or three [items], [BottomNavigationBarrType.shifting] otherwise.
  ///
  ...
  ///
  /// If [showSelectedLabels] is `null`, [BottomNavigationBarrThemeData.showSelectedLabels]
  /// is used. If [BottomNavigationBarrThemeData.showSelectedLabels]  is null,
  /// then [showSelectedLabels] defaults to `true`.
  ///
  /// If [showUnselectedLabels] is `null`, [BottomNavigationBarrThemeData.showUnselectedLabels]
  /// is used. If [BottomNavigationBarrThemeData.showSelectedLabels] is null,
  /// then [showUnselectedLabels] defaults to `true` when [type] is
  /// [BottomNavigationBarrType.fixed] and `false` when [type] is
  /// [BottomNavigationBarrType.shifting].
  BottomNavigationBarr({
    super.key,
    required this.items,
    this.onTap,
  ...
  /// track of the index of the selected [BottomNavigationBarrItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int>? onTap;

  /// The index into [items] for the current active [BottomNavigationBarrItem].
  final int currentIndex;

  /// The z-coordinate of this [BottomNavigationBarr].
  ///
  ...
  /// The color of the [BottomNavigationBarr] itself.
  ///
  /// If [type] is [BottomNavigationBarrType.shifting] and the
  /// [items] have [BottomNavigationBarrItem.backgroundColor] set, the [items]'
  /// backgroundColor will splash and overwrite this color.
  final Color? backgroundColor;

  /// The size of all of the [BottomNavigationBarrItem] icons.
  ///
  /// See [BottomNavigationBarrItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [BottomNavigationBarrItem.icon] and
  /// [BottomNavigationBarrItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color? selectedItemColor;

  /// The color of the unselected [BottomNavigationBarrItem.icon] and
  /// [BottomNavigationBarrItem.label]s.
  ///
  /// If null then the [ThemeData.unselectedWidgetColor]'s color is used.
  final Color? unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [BottomNavigationBarrItem.icon].
  ///
  ...
  /// [BottomNavigationBarrItem.icon]s.
  ///
  /// If this is not provided, the size will default to [iconSize], the color
  ...
  /// The [TextStyle] of the [BottomNavigationBarrItem] labels when they are
  /// selected.
  final TextStyle? selectedLabelStyle;

  /// The [TextStyle] of the [BottomNavigationBarrItem] labels when they are not
  /// selected.
  final TextStyle? unselectedLabelStyle;

  /// The font size of the [BottomNavigationBarrItem] labels when they are selected.
  ///
  ...
  /// The font size of the [BottomNavigationBarrItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the unselected [BottomNavigationBarrItem]s.
  final bool? showUnselectedLabels;

  /// Whether the labels are shown for the selected [BottomNavigationBarrItem].
  ...
  ///
  /// If null, then the value of [BottomNavigationBarrThemeData.mouseCursor] is used. If
  ...
  ///
  /// * [BottomNavigationBarrLandscapeLayout.spread] - the items are
  ///   evenly spaced and spread out across the available width. Each
  ///   item's label and icon are arranged in a column.
  /// * [BottomNavigationBarrLandscapeLayout.centered] - the items are
  ///   evenly spaced in a row but only consume as much width as they
  ///   would in portrait orientation. The row of items is centered within
  ///   the available width. Each item's label and icon are arranged
  ///   in a column.
  /// * [BottomNavigationBarrLandscapeLayout.linear] - the items are
  ///   evenly spaced and each item's icon and label are lined up in a
  ///   row instead of a column.
  ///
  /// If this property is null, then the value of the enclosing
  /// [BottomNavigationBarrThemeData.landscapeLayout is used. If that
  /// property is also null, then
  /// [BottomNavigationBarrLandscapeLayout.spread] is used.
  ///
  /// This property is null by default.
  ///
  /// See also:
  ///
  ///  * [ThemeData.BottomNavigationBarrTheme] - which can be used to specify
  ///    bottom navigation bar defaults for an entire application.
  ///  * [BottomNavigationBarrTheme] - which can be used to specify
  ///    bottom navigation bar defaults for a widget subtree.
  ///  * [MediaQuery.of] - which can be used to determine the current
  ///    orientation.
  final BottomNavigationBarrLandscapeLayout? landscapeLayout;

  /// This flag is controlling how [BottomNavigationBarr] is going to use
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final BottomNavigationBarrType type;
  ...
  final MouseCursor mouseCursor;
  final bool enableFeedback;
  final BottomNavigationBarrLandscapeLayout layout;
  ...
  Widget build(BuildContext context) {
    ...
    // The effective tool tip message to be shown on the BottomNavigationBarrItem.
    ...
    switch (type) {
      case BottomNavigationBarrType.fixed:
        size = 1;
      case BottomNavigationBarrType.shifting:
...
// BottomNavigationBarrLandscapeLayout.linear then return a
...
class _Tile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (MediaQuery.orientationOf(context) == Orientation.landscape && layout == BottomNavigationBarrLandscapeLayout.linear) {
      return Align(
        heightFactor: 1,
        child: Row(
...
class _BottomNavigationBarrState extends State<BottomNavigationBarr> with TickerProviderStateMixin {
  ...
  // [BottomNavigationBarrType.fixed] for 3 or fewer items, and
  // [BottomNavigationBarrType.shifting] is used for 4+ items.

  BottomNavigationBarrType get _effectiveType {
    return /*widget.type
        ?? BottomNavigationBarrTheme.of(context).type
        ?? */
        (widget.items.length <= 3 ? BottomNavigationBarrType.fixed : BottomNavigationBarrType.shifting);
  }

  // Computes the default value for the [showUnselected] parameter.
  //
  // Unselected labels are shown by default for [BottomNavigationBarrType.fixed],
  // and hidden by default for [BottomNavigationBarrType.shifting].
  ...
  @override
  void didUpdateWidget(BottomNavigationBarr oldWidget) {
  ...
  List<Widget> _createTiles(BottomNavigationBarrLandscapeLayout layout) {
    ...
    final IconThemeData effectiveSelectedIconTheme = _effectiveIconTheme(
        widget.selectedIconTheme ?? bottomTheme.selectedIconTheme, widget.selectedItemColor ?? bottomTheme.selectedItemColor ?? themeColor);

    final IconThemeData effectiveUnselectedIconTheme = _effectiveIconTheme(widget.unselectedIconTheme ?? bottomTheme.unselectedIconTheme,
    ...
    switch (_effectiveType) {
      case BottomNavigationBarrType.fixed:
        labelColorTween = ColorTween(
          begin:
              effectiveUnselectedLabelStyle.color ?? widget.unselectedItemColor ?? bottomTheme.unselectedItemColor ?? themeData.unselectedWidgetColor,
          end: effectiveSelectedLabelStyle.color ?? widget.selectedItemColor ?? bottomTheme.selectedItemColor ?? widget.fixedColor ?? themeColor,
        );
      case BottomNavigationBarrType.shifting:
        labelColorTween = ColorTween(
          begin:
              effectiveUnselectedLabelStyle.color ?? widget.unselectedItemColor ?? bottomTheme.unselectedItemColor ?? themeData.colorScheme.surface,
          end: effectiveSelectedLabelStyle.color ?? widget.selectedItemColor ?? bottomTheme.selectedItemColor ?? themeColor,
        );
    }
    ...
    switch (_effectiveType) {
      case BottomNavigationBarrType.fixed:
        iconColorTween = ColorTween(
          begin: effectiveSelectedIconTheme.color ?? widget.unselectedItemColor ?? bottomTheme.unselectedItemColor ?? themeData.unselectedWidgetColor,
          end: effectiveUnselectedIconTheme.color ?? widget.selectedItemColor ?? bottomTheme.selectedItemColor ?? widget.fixedColor ?? themeColor,
        );
      case BottomNavigationBarrType.shifting:
        iconColorTween = ColorTween(
          begin: effectiveUnselectedIconTheme.color ?? widget.unselectedItemColor ?? bottomTheme.unselectedItemColor ?? themeData.colorScheme.surface,
          end: effectiveSelectedIconTheme.color ?? widget.selectedItemColor ?? bottomTheme.selectedItemColor ?? themeColor,
        );
    }
    ...
    for (int i = 0; i < widget.items.length; i++) {
      ...
      tiles.add(_BottomNavigationTile(
        ...
        unselectedIconTheme:
            widget.useLegacyColorScheme ? widget.unselectedIconTheme ?? bottomTheme.unselectedIconTheme : effectiveUnselectedIconTheme,
  ...
  Widget build(BuildContext context) {
    ...
    final BottomNavigationBarThemeData bottomTheme = BottomNavigationBarTheme.of(context);
    final BottomNavigationBarrLandscapeLayout layout = /*widget.landscapeLayout
        // ?? bottomTheme.landscapeLayout
        ??*/
        BottomNavigationBarrLandscapeLayout.spread;
...
// BottomNavigationBarrLandscapeLayout.centered
class _Bar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (MediaQuery.orientationOf(context) == Orientation.landscape && layout == BottomNavigationBarrLandscapeLayout.centered) {
      alignedChild = Align(
        alignment: Alignment.bottomCenter,
        heightFactor: 1,
        child: SizedBox(
...
class _Circle {
  ...
  final _BottomNavigationBarrState state;
  final int index;
  final Color color;
