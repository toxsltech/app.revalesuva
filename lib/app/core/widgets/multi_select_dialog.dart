...
class MultiSelectDialogFieldd<V> extends FormField<List<V>> {
  ...
  MultiSelectDialogFieldd({
    ...
    this.key,
            ...
            builder: (FormFieldState<List<V>> state) {
              _MultiSelectDialogFielddView<V> field = _MultiSelectDialogFielddView<V>(
                title: title,
                items: items,
              ...
              return _MultiSelectDialogFielddView<V>._withState(field, state);
            });
}

// ignore: must_be_immutable
class _MultiSelectDialogFielddView<V> extends StatefulWidget {
  final MultiSelectListType? listType;
  final BoxDecoration? decoration;
  final Text? buttonText;
  final Icon? buttonIcon;
  ...
  /// This constructor allows a FormFieldState to be passed in. Called by MultiSelectDialogFieldd.
  _MultiSelectDialogFielddView._withState(_MultiSelectDialogFielddView<V> field, FormFieldState<List<V>> state)
      : items = field.items,
        title = field.title,
  ...
  @override
  __MultiSelectDialogFielddViewState createState() => __MultiSelectDialogFielddViewState<V>();
}

class __MultiSelectDialogFielddViewState<V> extends State<_MultiSelectDialogFielddView<V>> {
  ...
  @override
  void didUpdateWidget(_MultiSelectDialogFielddView<V> oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        InkWell(
          onTap: () {
            widget.disabled != true ? _showDialog(context) : null;
          },
          child: Container(
