  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        SliderTheme(
          data: _sliderThemeData.copyWith(inactiveTrackColor: Colors.transparent, thumbColor: appColor, activeTrackColor: appColor),
          child: Slider(
            min: 0.0,
            max: widget.duration.inMilliseconds.toDouble(),
        ...
        Positioned(
          right: 16.0,
          top: widget.isTablet == true ? margin_10 : null,
          bottom: 0.0,
